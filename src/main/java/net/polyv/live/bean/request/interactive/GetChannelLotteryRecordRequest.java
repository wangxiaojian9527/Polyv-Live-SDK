...
public class GetChannelLotteryRecordRequest extends PolyvLiveBaseRequest {
    ...
    public GetChannelLotteryRecordRequest(String appId, String appSecret, int channelId, String sessionId,
    ...
    public GetChannelLotteryRecordRequest(String appId, String appSecret, int channelId, String sessionId,
            long startTime, long endTime, int page, int limit) {
        super(appId, appSecret);
        this.channelId = channelId;
        this.sessionId = sessionId;
        this.startTime = startTime;
    ...
    public String toString() {
        return "GetLotteryRecordRequest{" + "channelId=" + channelId + ", sessionId='" + sessionId + '\'' +
