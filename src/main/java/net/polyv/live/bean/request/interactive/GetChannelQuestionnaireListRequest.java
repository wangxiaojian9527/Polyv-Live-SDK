...
public class GetChannelQuestionnaireListRequest extends PolyvLiveBaseRequest {
    ...
    public GetChannelQuestionnaireListRequest(String appId, String appSecret, String channelId, long startTime,
            long endTime) {
        super(appId, appSecret);
        this.channelId = channelId;
    ...
    public String toString() {
        return "GetChannelQuestionnaireListRequest{" + "channelId='" + channelId + '\'' + ", startTime=" + startTime +
                ", endTime=" + endTime + ", page=" + page + ", pageSize=" + pageSize + ", appId='" + appId + '\'' +
