...
public class GetWinnerDetailRequest extends PolyvLiveBaseRequest {
    ...
    public GetWinnerDetailRequest(String appId, String appSecret, int channelId, String lotteryId, int page,
            int limit) {
        super(appId, appSecret);
        this.channelId = channelId;
        this.lotteryId = lotteryId;
    ...
    public String toString() {
        return "GetWinnerDetailRequest{" + "channelId=" + channelId + ", lotteryId='" + lotteryId + '\'' + ", page=" +
                page + ", limit=" + limit + ", appId='" + appId + '\'' + ", appSecret='" + appSecret + '\'' +
