...
public class ApiConstants {
     ...
     * 修改直播频道分类名称
     */
    public static final String CHANGE_CHANNEL_CLASSIFICATION_NAME =
     ...
     */
    public static final String GET_CHANNEL_QUESTIONNAIRE_LIST =
     ...
     */
    public static final String SET_CHANNEL_QUESTIONNAIRE = "https://api.polyv.net/live/v3/channel/questionnaire/add" +
            "-edit-questionnaire?channelId={{channelId}}&appId={{appId}}&timestamp={{timestamp}}&sign={{sign}}";
